...
\affiliations{
	\num 1 \addr EECS, Massachusetts Institute of Technology, Cambridge, MA, USA \\
	\num 2 \addr School of Electrical and Computer Engineering, Cornell University, Ithaca, NY, USA \\
...
% \newfontfamily\EBInitF{EBGaramond-InitialsF1.otf}
% \newfontfamily\EBInitFF{EBGaramond-InitialsF2.otf}
\usepackage{lettrine}
% \newcommand{\enluminure}[2]{\lettrine[lines=4,lhang=0.1,findent=0.5em,nindent=0em]{\large \initfamily \textcolor{black}{#1}}{\bfseries\textcolor{black}{#2}}}
