...
> 
> [PLEASE DISCLOSE IF YOU USED A LARGE-LANGUAGE MODEL (LLM) OR ANY OTHER GENERATIVE AI APPROACH (GENAI), AND HOW IT WAS USED. MELBA POLICY ALLOWS LLMS/GENAI TO BE USED TO HELP POLISH TEXT OR DRAFT INITIAL BULLET-POINTS, BUT NOT FOR UNSUPERVISED, DE NOVO CONTENT CREATION FOR THE MANUSCRIPT.]
>
...
* **MELBA–BVM 2025 Special Issue** *Guest editors:* Andreas Maier, Thomas Deserno, Heinz Handels, Klaus Maier-Hein, Christoph Palm, Thomas Tolxdorff, Katharina Breininger
* **Uncertainty for Safe Utilization of Machine Learning in Medical Imaging (UNSURE) 2025** *Guest editors:* Mobarak Hoque, Raghav Mehta, Cheng Ouyang, Chen Qin, Marianne Rakic, Sandy Wells
* **Medical Imaging with Deep Learning (MIDL) 2025 special issue** *Guest editors:* Lisa Koch, Ronald M. Summers, Chen Chen, Yan Zhuang
